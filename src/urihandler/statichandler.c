...
{
    extern const unsigned char styles_start[] asm("_binary_index_css_start");
...
esp_err_t react_vendor_js_get_handler(httpd_req_t *req)
{
    ...
    extern const unsigned char vendorjs_start_lol[] asm("_binary_vendor_js_start");
...
{
     extern const char routerjs_start_lol[] asm("_binary_router_js_start");
     httpd_resp_set_type(req, "text/javascript");
    ESP_LOGD(TAG_HANDLER, "Requesting style");
...
{
     extern const char reactindxjs_start_lol[] asm("_binary_index_js_start");
     httpd_resp_set_type(req, "text/javascript");
    ESP_LOGD(TAG_HANDLER, "Requesting style");
